//merge sort is a best example of recursion as it follow divide and conquer Algorithm
import java.util.*;
public class MergeSort {
    
    public static void merge(int arr[],int low,int mid,int high) //conquer call
    {
